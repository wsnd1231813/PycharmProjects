...
class Gh(object):
    def __init__(self):
        ...
        self.L = 35  # 客户数目，染色体长度
        self.k = 10  # 最大车的数目
        self.T = 100# 迭代次数
        self.capacity = 100
        self.city_demand = [0.0, 1.0, 14.0, 15.0, 11.0, 18.0, 2.0, 22.0, 7.0, 18.0, 23.0, 12.0, 21.0, 2.0, 14.0, 9.0, 10.0, 4.0, 19.0, 2.0, 20.0, 15.0, 11.0, 6.0, 13.0, 19.0, 13.0, 8.0, 15.0, 18.0, 11.0, 21.0, 12.0, 2.0, 23.0, 11.0]
    ...
    # 客户间的距离
    def distance(self):
        x = [15.0, 1.0, 87.0, 69.0, 93.0, 33.0, 71.0, 29.0, 93.0, 55.0, 23.0, 19.0, 57.0, 5.0, 65.0, 69.0, 3.0, 19.0, 21.0, 67.0, 41.0, 19.0, 15.0, 79.0, 19.0, 27.0, 29.0, 25.0, 59.0, 27.0, 21.0, 61.0, 15.0, 31.0, 71.0, 91.0]
        y = [19.0, 49.0, 25.0, 65.0, 91.0, 31.0, 61.0, 9.0, 7.0, 47.0, 13.0, 47.0, 63.0, 95.0, 43.0, 1.0, 25.0, 91.0, 81.0, 91.0, 23.0, 75.0, 79.0, 47.0, 65.0, 49.0, 17.0, 65.0, 51.0, 95.0, 91.0, 83.0, 83.0, 87.0, 41.0, 21.0]
