...
class Gh(object):
    def __init__(self):
        ...
        self.L = 75  # 客户数目，染色体长度
        self.k = 15  # 最大车的数目
        self.T = 100 # 迭代次数
        self.capacity = 220
        self.city_demand = [0.0, 18.0, 26.0, 11.0, 30.0, 21.0, 19.0, 15.0, 16.0, 29.0, 26.0, 37.0, 16.0, 12.0, 31.0, 8.0, 19.0, 20.0, 13.0, 15.0, 22.0, 28.0, 12.0, 6.0, 27.0, 14.0, 18.0, 17.0, 29.0, 13.0, 22.0, 25.0, 28.0, 27.0, 19.0, 10.0, 12.0, 14.0, 24.0, 16.0, 33.0, 15.0, 11.0, 18.0, 17.0, 21.0, 27.0, 19.0, 20.0, 5.0, 22.0, 12.0, 19.0, 22.0, 16.0, 7.0, 26.0, 14.0, 21.0, 24.0, 13.0, 15.0, 18.0, 11.0, 28.0, 9.0, 37.0, 30.0, 10.0, 8.0, 11.0, 3.0, 1.0, 6.0, 10.0, 20.0]
    ...
    # 客户间的距离
    def distance(self):
        x = [40.0, 22.0, 36.0, 21.0, 45.0, 55.0, 33.0, 50.0, 55.0, 26.0, 40.0, 55.0, 35.0, 62.0, 62.0, 62.0, 21.0, 33.0, 9.0, 62.0, 66.0, 44.0, 26.0, 11.0, 7.0, 17.0, 41.0, 55.0, 35.0, 52.0, 43.0, 31.0, 22.0, 26.0, 50.0, 55.0, 54.0, 60.0, 47.0, 30.0, 30.0, 12.0, 15.0, 16.0, 21.0, 50.0, 51.0, 50.0, 48.0, 12.0, 15.0, 29.0, 54.0, 55.0, 67.0, 10.0, 6.0, 65.0, 40.0, 70.0, 64.0, 36.0, 30.0, 20.0, 15.0, 50.0, 57.0, 45.0, 38.0, 50.0, 66.0, 59.0, 35.0, 27.0, 40.0, 40.0]
        y = [40.0, 22.0, 26.0, 45.0, 35.0, 20.0, 34.0, 50.0, 45.0, 59.0, 66.0, 65.0, 51.0, 35.0, 57.0, 24.0, 36.0, 44.0, 56.0, 48.0, 14.0, 13.0, 13.0, 28.0, 43.0, 64.0, 46.0, 34.0, 16.0, 26.0, 26.0, 76.0, 53.0, 29.0, 40.0, 50.0, 10.0, 15.0, 66.0, 60.0, 50.0, 17.0, 14.0, 19.0, 48.0, 30.0, 42.0, 15.0, 21.0, 38.0, 56.0, 39.0, 38.0, 57.0, 41.0, 70.0, 25.0, 27.0, 60.0, 64.0, 4.0, 6.0, 20.0, 30.0, 5.0, 70.0, 72.0, 42.0, 33.0, 4.0, 8.0, 5.0, 60.0, 24.0, 20.0, 37.0]
