...
class Gh(object):
    def __init__(self):
        ...
        self.L = 79  # 客户数目，染色体长度
        self.k = 15  # 最大车的数目
        self.T = 1000# 迭代次数
        self.capacity = 80
        self.city_demand = [0.0, 24.0, 22.0, 23.0, 5.0, 11.0, 23.0, 26.0, 9.0, 23.0, 9.0, 14.0, 16.0, 12.0, 2.0, 2.0, 6.0, 20.0, 26.0, 12.0, 15.0, 13.0, 26.0, 17.0, 7.0, 12.0, 4.0, 4.0, 20.0, 10.0, 9.0, 2.0, 9.0, 1.0, 2.0, 2.0, 12.0, 14.0, 23.0, 21.0, 13.0, 13.0, 23.0, 3.0, 6.0, 23.0, 11.0, 2.0, 7.0, 13.0, 10.0, 3.0, 6.0, 13.0, 2.0, 14.0, 7.0, 21.0, 7.0, 22.0, 13.0, 22.0, 18.0, 22.0, 6.0, 2.0, 11.0, 5.0, 9.0, 9.0, 5.0, 12.0, 2.0, 12.0, 19.0, 6.0, 14.0, 2.0, 2.0, 24.0]
    ...
    # 客户间的距离
    def distance(self):
        x = [92.0, 88.0, 70.0, 57.0, 0.0, 61.0, 65.0, 91.0, 59.0, 3.0, 95.0, 80.0, 66.0, 79.0, 99.0, 20.0, 40.0, 50.0, 97.0, 21.0, 36.0, 100.0, 11.0, 69.0, 69.0, 29.0, 14.0, 50.0, 89.0, 57.0, 60.0, 48.0, 17.0, 21.0, 77.0, 2.0, 63.0, 68.0, 41.0, 48.0, 98.0, 26.0, 69.0, 40.0, 65.0, 14.0, 32.0, 14.0, 96.0, 82.0, 23.0, 63.0, 87.0, 56.0, 15.0, 10.0, 7.0, 31.0, 36.0, 50.0, 49.0, 39.0, 76.0, 83.0, 33.0, 0.0, 52.0, 52.0, 46.0, 3.0, 46.0, 94.0, 26.0, 75.0, 57.0, 34.0, 28.0, 59.0, 51.0, 87.0]
        y = [92.0, 58.0, 6.0, 59.0, 98.0, 38.0, 22.0, 52.0, 2.0, 54.0, 38.0, 28.0, 42.0, 74.0, 25.0, 43.0, 3.0, 42.0, 0.0, 19.0, 21.0, 61.0, 85.0, 35.0, 22.0, 35.0, 9.0, 33.0, 17.0, 44.0, 25.0, 42.0, 93.0, 50.0, 18.0, 4.0, 83.0, 6.0, 95.0, 54.0, 73.0, 38.0, 76.0, 1.0, 41.0, 86.0, 39.0, 24.0, 5.0, 98.0, 85.0, 69.0, 19.0, 75.0, 63.0, 45.0, 30.0, 11.0, 93.0, 31.0, 52.0, 10.0, 40.0, 34.0, 51.0, 15.0, 82.0, 82.0, 6.0, 26.0, 80.0, 30.0, 76.0, 92.0, 51.0, 21.0, 80.0, 66.0, 16.0, 11.0]
