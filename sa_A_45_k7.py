...
class Gh(object):
    def __init__(self):
        ...
        self.L = 44  # 客户数目，染色体长度
        self.k = 10  # 最大车的数目
        self.T = 100 # 迭代次数
        self.capacity = 100
        self.city_demand = [0.0, 14.0, 1.0, 16.0, 23.0, 12.0, 6.0, 5.0, 1.0, 13.0, 20.0, 14.0, 18.0, 7.0, 8.0, 21.0, 8.0, 24.0, 20.0, 19.0, 13.0, 3.0, 26.0, 17.0, 22.0, 8.0, 16.0, 20.0, 12.0, 22.0, 20.0, 12.0, 14.0, 25.0, 17.0, 19.0, 20.0, 15.0, 2.0, 9.0, 10.0, 6.0, 11.0, 21.0, 24.0]
    ...
    # 客户间的距离
    def distance(self):
        x = [61.0, 95.0, 45.0, 15.0, 39.0, 55.0, 29.0, 87.0, 75.0, 65.0, 73.0, 17.0, 39.0, 75.0, 49.0, 85.0, 89.0, 89.0, 79.0, 45.0, 93.0, 49.0, 63.0, 93.0, 39.0, 89.0, 47.0, 29.0, 13.0, 33.0, 63.0, 41.0, 67.0, 41.0, 49.0, 57.0, 45.0, 83.0, 81.0, 57.0, 93.0, 17.0, 89.0, 7.0, 35.0]
        y = [99.0, 7.0, 87.0, 47.0, 75.0, 23.0, 71.0, 79.0, 63.0, 61.0, 35.0, 35.0, 99.0, 77.0, 37.0, 31.0, 71.0, 43.0, 81.0, 5.0, 69.0, 69.0, 25.0, 33.0, 45.0, 33.0, 77.0, 19.0, 65.0, 9.0, 9.0, 13.0, 75.0, 27.0, 77.0, 81.0, 5.0, 7.0, 61.0, 81.0, 89.0, 13.0, 27.0, 25.0, 35.0]
