...
class Gh(object):
    def __init__(self):
        ...
        self.T = 100 # 迭代次数
        self.capacity = 8000
        self.city_demand = [0.0, 700.0, 400.0, 400.0, 1200.0, 40.0, 80.0, 2000.0, 900.0, 600.0, 750.0, 1500.0, 150.0, 250.0, 1600.0, 450.0, 700.0, 550.0, 650.0, 200.0, 400.0, 300.0, 1300.0, 700.0, 750.0, 1400.0, 4000.0, 600.0, 1000.0, 500.0, 2500.0, 1700.0, 1100.0]
    ...
    # 客户间的距离
    def distance(self):
        x = [292.0, 298.0, 309.0, 307.0, 336.0, 320.0, 321.0, 322.0, 323.0, 324.0, 323.0, 314.0, 311.0, 304.0, 293.0,
             296.0, 261.0, 297.0, 315.0, 314.0, 321.0, 321.0, 314.0, 313.0, 304.0, 295.0, 283.0, 279.0, 271.0, 264.0,
             277.0, 290.0, 319.0]
        y = [495.0, 427.0, 445.0, 464.0, 475.0, 439.0, 437.0, 437.0, 433.0, 433.0, 429.0, 435.0, 442.0, 427.0, 421.0,
             418.0, 384.0, 410.0, 407.0, 406.0, 391.0, 398.0, 394.0, 378.0, 382.0, 402.0, 406.0, 399.0, 401.0, 414.0,
             439.0, 434.0, 433.0]
