...
class Gh(object):
    def __init__(self):
        ...
        self.L = 50  # 客户数目，染色体长度
        self.k = 10  # 最大车的数目
        self.T = 100 # 迭代次数
        self.capacity = 160
        self.city_demand = [0.0, 7.0, 30.0, 16.0, 9.0, 21.0, 15.0, 19.0, 23.0, 11.0, 5.0, 19.0, 29.0, 23.0, 21.0, 10.0, 15.0, 3.0, 41.0, 9.0, 28.0, 8.0, 8.0, 16.0, 10.0, 28.0, 7.0, 15.0, 14.0, 6.0, 19.0, 11.0, 12.0, 23.0, 26.0, 17.0, 6.0, 9.0, 15.0, 14.0, 7.0, 27.0, 13.0, 11.0, 16.0, 10.0, 5.0, 25.0, 17.0, 18.0, 10.0]
    ...
    # 客户间的距离
    def distance(self):
        x = [30.0, 37.0, 49.0, 52.0, 20.0, 40.0, 21.0, 17.0, 31.0, 52.0, 51.0, 42.0, 31.0, 5.0, 12.0, 36.0, 52.0, 27.0,
             17.0, 13.0, 57.0, 62.0, 42.0, 16.0, 8.0, 7.0, 27.0, 30.0, 43.0, 58.0, 58.0, 37.0, 38.0, 46.0, 61.0, 62.0,
             63.0, 32.0, 45.0, 59.0, 5.0, 10.0, 21.0, 5.0, 30.0, 39.0, 32.0, 25.0, 25.0, 48.0, 56.0]
        y = [40.0, 52.0, 49.0, 64.0, 26.0, 30.0, 47.0, 63.0, 62.0, 33.0, 21.0, 41.0, 32.0, 25.0, 42.0, 16.0, 41.0, 23.0,
             33.0, 13.0, 58.0, 42.0, 57.0, 57.0, 52.0, 38.0, 68.0, 48.0, 67.0, 48.0, 27.0, 69.0, 46.0, 10.0, 33.0, 63.0,
             69.0, 22.0, 35.0, 15.0, 6.0, 17.0, 10.0, 64.0, 15.0, 10.0, 39.0, 32.0, 55.0, 28.0, 37.0]
