...
class Gh(object):
    def __init__(self):
        ...
        self.L = 64  # 客户数目，染色体长度
        self.k = 15  # 最大车的数目
        self.T = 100 # 迭代次数
        self.capacity = 100
        self.city_demand = [0.0, 12.0, 24.0, 16.0, 7.0, 9.0, 20.0, 10.0, 18.0, 26.0, 17.0, 2.0, 11.0, 9.0, 12.0, 11.0, 12.0, 23.0, 7.0, 1.0, 26.0, 10.0, 9.0, 22.0, 21.0, 17.0, 2.0, 15.0, 16.0, 14.0, 23.0, 24.0, 2.0, 12.0, 18.0, 5.0, 19.0, 15.0, 8.0, 6.0, 14.0, 13.0, 5.0, 24.0, 25.0, 2.0, 8.0, 14.0, 2.0, 13.0, 10.0, 6.0, 6.0, 24.0, 21.0, 20.0, 24.0, 4.0, 19.0, 14.0, 23.0, 2.0, 16.0, 23.0, 14.0]
    ...
    # 客户间的距离
    def distance(self):
        x = [25.0, 35.0, 93.0, 53.0, 51.0, 51.0, 1.0, 9.0, 75.0, 15.0, 79.0, 9.0, 39.0, 47.0, 33.0, 27.0, 83.0, 17.0, 47.0, 57.0, 87.0, 55.0, 21.0, 21.0, 67.0, 59.0, 1.0, 33.0, 25.0, 45.0, 63.0, 1.0, 77.0, 35.0, 9.0, 61.0, 59.0, 63.0, 97.0, 9.0, 93.0, 83.0, 95.0, 31.0, 77.0, 63.0, 3.0, 11.0, 7.0, 37.0, 75.0, 15.0, 69.0, 69.0, 5.0, 49.0, 77.0, 15.0, 91.0, 79.0, 67.0, 93.0, 25.0, 9.0, 3.0]
        y = [51.0, 7.0, 75.0, 95.0, 81.0, 55.0, 67.0, 23.0, 7.0, 97.0, 5.0, 19.0, 1.0, 1.0, 97.0, 83.0, 79.0, 59.0, 19.0, 9.0, 41.0, 25.0, 91.0, 13.0, 1.0, 21.0, 75.0, 85.0, 21.0, 29.0, 77.0, 77.0, 41.0, 11.0, 77.0, 87.0, 91.0, 79.0, 67.0, 45.0, 21.0, 71.0, 57.0, 69.0, 17.0, 57.0, 63.0, 69.0, 9.0, 65.0, 83.0, 53.0, 5.0, 27.0, 19.0, 31.0, 17.0, 7.0, 39.0, 17.0, 75.0, 51.0, 33.0, 19.0, 65.0]
